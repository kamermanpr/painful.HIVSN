...
# Load data
df_all <- read_csv('./data/data_all_2SignsOnly.csv')
...
df_all %>%
    ...
    write_csv('./data/2SignsOnly_pain-intensity.csv')
...
df_all %>%
    ...
    rename(time_since_diag = `time_sinc_ diag`,
           vitB12 = vitb12) %>%
    write_csv('./data/2SignsOnly_pain-vs-no-pain.csv')
...
df_all %>%
    ...
    write_csv('./data/2SignsOnly_qol-pain-intensity.csv')
...
df_all %>%
    ...
    rename(eq5d_vas = `eq-5d_vas`,
           hscl_depression_score = hscl_depression,
           hscl_anxiety_score = hscl_anxiety) %>%
    write_csv('./data/2SignsOnly_qol-pain-vs-no-pain.csv')
